CLASS zcl_12_atc_check DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_12_ATC_CHECK IMPLEMENTATION.
...
* Find a passenger flight from Frank furt to New York
...
** Find a cargo flight from Frank furt to New York
